...
# RLock: atualizar_setor segura o lock durante o ciclo inteiro e chama
# registrar_historico/write_setores_to_csv, que readquirem o mesmo lock.
...
def atualizar_setor(setor_id: int, dados: SetorBase):
    # O corpo fica numa funcao interna para o lock cobrir leitura, historico
    # e gravacao sem reindentar todo o bloco.
    with lock:
        return _atualizar_setor(setor_id, dados)


def _atualizar_setor(setor_id: int, dados: SetorBase) -> SetorResponse:
    setores = read_setor_from_csv()
